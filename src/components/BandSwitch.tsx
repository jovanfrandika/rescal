...
const BandSwitch = () => {
  ...
  return (
    <div className={clsx('absolute transition transform mx-auto px-4 py-1 bg-gray-300 border-2 border-gray-100 shadow-lg rounded-3xl hover:-translate-y-1', { [`bg-blue-400`]: isFive }, { [`bg-yellow-200`]: !isFive })}>
      <div
